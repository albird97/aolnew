 ...
 * --------------------------------------------------------------------------- */
load_theme_textdomain( 'AOL',  LANG_DIR );
load_theme_textdomain( 'aol-opts', LANG_DIR );
...
require( THEME_DIR .'/aol-options/theme-options.php' );
...
// Custom post types ----------------------------------------------------------
$post_types_disable = aol_opts_get( 'post-type-disable' );
