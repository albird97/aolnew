...
if( ! function_exists( 'mfn_wp_nav_menu' ) )
{
	function mfn_wp_nav_menu() 
	{
		...
		// Custom Menu
		if( mfn_ID() && is_single() && get_post_type() == 'post' && $custom_menu = aol_opts_get( 'blog-single-menu' ) ){
			// Theme Options | Single Posts
			$args['menu']			= $custom_menu;
		} elseif( mfn_ID() && is_single() && get_post_type() == 'portfolio' && $custom_menu = aol_opts_get( 'portfolio-single-menu' ) ){
