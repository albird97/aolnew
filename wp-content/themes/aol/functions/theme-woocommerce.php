...
if( aol_opts_get( 'shop-catalogue' ) ){
		...
		?>
				...
				<?php 
					...
					if( is_search() ){
						...
						if( is_product() && aol_opts_get('shop-sidebar') ){
...
if( ! function_exists( 'mfn_woo_per_page' ) )
{
	function mfn_woo_per_page( $cols ){
		return aol_opts_get( 'shop-products', 12 );
	}
}
...
if( ! function_exists( 'mfn_woo_related_products_args' ) )
{
	function mfn_woo_related_products_args( $args ) {
		$args['posts_per_page'] = intval( aol_opts_get( 'shop-related', 3 ) );
		return $args;
	}
}
...
if( ! function_exists( 'woocommerce_header_add_to_cart_fragment' ) )
{
	function woocommerce_header_add_to_cart_fragment( $fragments ) {
		...
		$cart_icon = aol_opts_get('shop-cart');
