...
if( ! function_exists( 'mfn_portfolio_post_type' ) )
{
	...
	{
		$slug 	= aol_opts_get( 'portfolio-slug', 'portfolio-item' );
		$tax	= aol_opts_get( 'portfolio-tax', 'portfolio-types' );
		...
		$mfn_portfolio_meta_box = array(
			...
			'fields' 	=> array(
				...
				array(
					...
					'std' 		=> aol_opts_get( 'sidebar-layout' ),
				),
				...
				array(
					...
					'options' 	=> aol_opts_get( 'sidebars' ),
				),
					
				array(
					'id' 		=> 'aol-post-sidebar2',
					'type' 		=> 'select',
