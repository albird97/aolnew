...
if( ! function_exists( 'aol_builder_print_content' ) )
{
	/**
	 ...
	 */
	function aol_builder_print_content( $post_id, $content_field = false ){
...
if( ! function_exists( 'aol_builder_print' ) )
{
	/**
	 * PRINT AOL Theme Builder
	 * 
	 * @param int $post_id
	 * @param bool $content_field
	 */
	function aol_builder_print( $post_id, $content_field = false ){
		...
		if( aol_opts_get('display-order') == 1 ) aol_builder_print_content( $post_id, $content_field );
...
// 				print_r($section['attr']);
		...
		// WordPress Editor Content -------------------------------------
		if( aol_opts_get('display-order') == 0 ) aol_builder_print_content( $post_id, $content_field );
