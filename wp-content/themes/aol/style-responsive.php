...
<?php 
	$mobileMenuInitW = $stickyMenuInitW = aol_opts_get( 'mobile-menu-initial', 1240 );

	$responsive_header_tab = aol_opts_get( 'responsive-header-tablet' );
	if( is_array( $responsive_header_tab ) && isset( $responsive_header_tab['sticky'] ) ){
		$stickyMenuInitW = 768;
	}
	
	if( aol_header_style( true ) == 'header-fixed' ){
