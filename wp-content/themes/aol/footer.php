...
<?php do_action( 'aol_hook_content_after' ); ?>

<!-- #Footer -->		
<footer id="Footer" class="clearfix">
	
	<?php if ( $footer_call_to_action = aol_opts_get('footer-call-to-action') ): ?>
	...
	<?php 
		...
		if( $sidebars_count > 0 ){
			...
			if( aol_opts_get( 'footer-padding' ) ){
				$footer_style .= 'padding:'. aol_opts_get( 'footer-padding' ) .';';
			}
			
			echo '<div class="widgets_wrapper" style="'. $footer_style .'">';
				echo '<div class="container">';
						
					if( $footer_layout = aol_opts_get( 'footer-layout' ) ){
						// Theme Options
	...
	<?php if( aol_opts_get('footer-hide') != 1 ): ?>
		...
		<div class="footer_copy">
			<div class="container">
				<div class="column one">
					...
					<div class="copyright">
						<?php 
							if( aol_opts_get('footer-copy') ){
								echo do_shortcode( aol_opts_get('footer-copy') );
							} else {
								echo '&copy; '. date( 'Y' ) .' '. get_bloginfo( 'name' ) .'. All Rights Reserved. <a target="_blank" rel="nofollow" href="#">Capstone Group 12</a>';
							}
						?>
					</div>
...
<?php 
	...
	if( aol_opts_get( 'responsive-mobile-menu' ) ){
...
<?php if( aol_opts_get('popup-contact-form') ): ?>
	<div id="popup_contact">
		<a class="button button_js" href="#"><i class="<?php aol_opts_show( 'popup-contact-form-icon', 'icon-mail-line' ); ?>"></i></a>
		<div class="popup_contact_wrapper">
			<?php echo do_shortcode( aol_opts_get('popup-contact-form') ); ?>
			<span class="arrow"></span>
		</div>
	</div>
<?php endif; ?>

<?php do_action( 'aol_hook_bottom' ); ?>
