...
$class = '';
if( get_post_meta( get_the_ID(), 'aol-post-template', true ) == 'builder' ) $class .= 'no-padding';
?>
	...
	<div class="content_wrapper clearfix">
		...
		<div class="sections_group">
			...
			<?php 
				...
				if( get_post_meta( get_the_ID(), 'aol-post-template', true ) == 'builder' ){
					...
					while( have_posts() ){
						the_post();							// Post Loop
						aol_builder_print( get_the_ID() );	// Content Builder & WordPress Editor Content
					}
					...
					if( aol_opts_get('portfolio-comments') ){
