<?php
	...
	$creative_classes = '';
	$creative_options = aol_opts_get( 'menu-creative-options' );
			...
			<div class="one">
				...
				<div class="top_bar_left">
					...
					<div class="menu_wrapper">
						<?php 
							...
							echo '<a class="responsive-menu-toggle '. $mb_class .'" href="#">';
								if( $menu_text = aol_opts_get( 'header-menu-text' ) ){
					...
					<div class="search_wrapper">
						<!-- #searchform -->
						<?php $translate['search-placeholder'] = aol_opts_get('translate') ? aol_opts_get('translate-search-placeholder','Enter your search') : __('Enter your search','betheme'); ?>
						<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
							<?php if( aol_opts_get('header-search') == 'shop' ): ?>
