...
// Search
$header_search = aol_opts_get( 'header-search' );

// Action Button
$action_link = aol_opts_get( 'header-action-link' );

// WPML Icon
if( has_nav_menu( 'lang-menu' ) ){
	$wpml_icon = true;
} elseif( function_exists( 'icl_get_languages' ) && aol_opts_get( 'header-wpml' ) != 'hide' ){
	$wpml_icon = true;
} else {
	$wpml_icon = false;
}
