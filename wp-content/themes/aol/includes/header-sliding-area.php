<?php
if( aol_opts_get('sliding-top') ){
	
	$st_class = 'st-'. aol_opts_get('sliding-top');
	...
	echo '<div id="Sliding-top" class="'. $st_class .'">';
		...
		echo '<a href="#" class="sliding-top-control"><span><i class="plus '. aol_opts_get( 'sliding-top-icon', 'icon-down-open-mini' ) .'"></i><i class="minus icon-up-open-mini"></i></span></a>';
	echo '</div>';
