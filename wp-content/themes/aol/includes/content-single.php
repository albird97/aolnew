...
$opts_single_post_nav = aol_opts_get( 'prev-next-nav' );
...
if( ! aol_opts_get( 'blog-title' ) ) $classes[] = 'no-title';

if( aol_opts_get( 'share' ) == 'hide-mobile' ){
	$classes[] = 'no-share-mobile';
} elseif( ! aol_opts_get( 'share' ) ) {
	$classes[] = 'no-share';
}


$translate['published'] 	= aol_opts_get('translate') ? aol_opts_get('translate-published','Published by') : __('Published by','betheme');
$translate['at'] 			= aol_opts_get('translate') ? aol_opts_get('translate-at','at') : __('at','betheme');
$translate['tags'] 			= aol_opts_get('translate') ? aol_opts_get('translate-tags','Tags') : __('Tags','betheme');
$translate['categories'] 	= aol_opts_get('translate') ? aol_opts_get('translate-categories','Categories') : __('Categories','betheme');
$translate['all'] 			= aol_opts_get('translate') ? aol_opts_get('translate-all','Show all') : __('Show all','betheme');
$translate['related'] 		= aol_opts_get('translate') ? aol_opts_get('translate-related','Related posts') : __('Related posts','betheme');
$translate['readmore'] 		= aol_opts_get('translate') ? aol_opts_get('translate-readmore','Read more') : __('Read more','betheme');
?>
...
<div id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<?php if( get_post_meta( get_the_ID(), 'aol-post-template', true ) != 'intro' ): ?>
			...
			<div class="section_wrapper clearfix">
				...
				<div class="column one post-header">
					...
					<div class="title_wrapper">
						...
						<?php
							if( aol_opts_get( 'blog-title' ) ){ 
								if( get_post_format() == 'quote'){
									echo '<blockquote>'. get_the_title() .'</blockquote>';
								} else {
									$h = aol_opts_get( 'title-heading', 1 );
						...
						<?php 
							$show_meta = false;
							$blog_meta = aol_opts_get( 'blog-meta' );
						...
						<?php if( $show_meta ): ?>
							<div class="post-meta clearfix">
								...
								<div class="author-date">
									...
									<?php if( aol_opts_get( 'mfn-seo-schema-type' ) ): ?>
										...
										<div itemprop="publisher" itemscope itemtype="https://schema.org/Organization" style="display:none;">
											...
											<div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
												<img src="<?php aol_opts_show( 'logo-img' ) ?>" itemprop="url" content="<?php aol_opts_show( 'logo-img' ) ?>"/>
											</div>
				...
				<div class="column one single-photo-wrapper <?php echo mfn_post_thumbnail_type( get_the_ID() ); ?>">
					...
					<?php if( ! post_password_required() ): ?>
						<div class="image_frame scale-with-grid <?php if( ! aol_opts_get('blog-single-zoom') ) echo 'disabled'; ?>">
							...
							<?php 
								if( $caption = get_post( get_post_thumbnail_id() )->post_excerpt ){
							    	echo '<p class="wp-caption-text '. aol_opts_get( 'featured-image-caption' ) .'">'. $caption .'</p>';
								}
							?>
	...
	<div class="post-wrapper-content">
		...
		<?php if( aol_opts_get( 'share' ) && ( get_post_meta( get_the_ID(), 'aol-post-template', true ) == 'intro' ) ): ?>
		...
		<div class="section section-post-about">
			<div class="section_wrapper clearfix">
				...
				<?php if( aol_opts_get( 'blog-author' ) ): ?>
	...
	<div class="section section-post-related">
		<div class="section_wrapper clearfix">
			...
			<?php
				if( aol_opts_get( 'blog-related' ) && $aCategories = wp_get_post_categories( get_the_ID() ) ){

					$related_count  = intval( aol_opts_get( 'blog-related' ) );
					$related_cols 	= 'col-'. absint( aol_opts_get( 'blog-related-columns', 3 ) );
					$related_style	= aol_opts_get( 'related-style' );
						...
						echo '<div class="section-related-adjustment '. $related_style .'">';
							...
							echo '<div class="section-related-ul '. $related_cols .'">';
								...
								while ( $query_related_posts->have_posts() ){
									...
									if( aol_opts_get( 'blog-related-images' ) ){
										$post_format = aol_opts_get( 'blog-related-images' );
									}
											...
											echo '<div class="single-photo-wrapper '. $post_format .'">';
												echo '<div class="image_frame scale-with-grid">';
													...
													echo '<div class="image_wrapper">';
														echo mfn_post_thumbnail( get_the_ID(), 'related', false, aol_opts_get( 'blog-related-images' ) );
													echo '</div>';
	...
	<?php if( aol_opts_get( 'blog-comments' ) ): ?>
