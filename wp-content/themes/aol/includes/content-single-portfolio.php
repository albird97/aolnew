...
if( ! aol_opts_get( 'portfolio-single-title' ) ) $classes[] = 'no-title';
...
$translate['client'] 		= aol_opts_get('translate') ? aol_opts_get('translate-client','Client') : __('Client','betheme');
$translate['date'] 			= aol_opts_get('translate') ? aol_opts_get('translate-date','Date') : __('Date','betheme');
$translate['website'] 		= aol_opts_get('translate') ? aol_opts_get('translate-website','Website') : __('Website','betheme');
$translate['view'] 			= aol_opts_get('translate') ? aol_opts_get('translate-view','View website') : __('View website','betheme');
$translate['task'] 			= aol_opts_get('translate') ? aol_opts_get('translate-task','Task') : __('Task','betheme');
?>
...
<div id="portfolio-item-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
			...
			<div class="section_wrapper clearfix">
				...
				<div class="column one post-header">
					...
					<div class="title_wrapper">
						...
						<?php
							if( aol_opts_get( 'portfolio-single-title' ) ){
	...
	<div class="section section-post-related">
		<div class="section_wrapper clearfix">
			...
			<?php
				if( aol_opts_get( 'portfolio-related' ) && $aCategories ){
					
					$related_count  = intval( aol_opts_get( 'portfolio-related' ) );
					$related_cols 	= 'col-'. absint( aol_opts_get( 'portfolio-related-columns', 3 ) );
