		...
		$sections['advanced'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' 		=> __('For more info please contact administrator', 'mfn-opts'),
		...
		$sections['hooks'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'sub_desc'	=> __('aol_hook_top', 'mfn-opts'),
				...
				array(
					...
					'sub_desc'	=> __('aol_hook_content_before', 'mfn-opts'),
				...
				array(
					...
					'sub_desc'	=> __('aol_hook_content_after', 'mfn-opts'),
				...
				array(
					...
					'sub_desc'	=> __('aol_hook_bottom', 'mfn-opts'),
 ...
 */
if( ! function_exists( 'aol_opts_get' ) )
{
	function aol_opts_get( $opt_name, $default = null ){
		global $MFN_Options;
 ...
 */
if( ! function_exists( 'aol_opts_show' ) )
{
	function aol_opts_show( $opt_name, $default = null ){
		global $MFN_Options;
