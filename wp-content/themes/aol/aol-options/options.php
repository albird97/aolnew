...
//		define('MFN_OPTIONS_URI', site_url(str_replace(ABSPATH, '', trailingslashit(dirname(__FILE__)))));
		define('MFN_OPTIONS_URI', THEME_URI ."/aol-options/");	
	}
	...
	class MFN_Options{
		...
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['menu_title'] 	= __('AOL Theme Options', 'mfn-opts');
			$defaults['page_icon'] 		= 'icon-themes';
			$defaults['page_title'] 	= __('AOL Theme Options', 'mfn-opts');
...
// 									echo '<a class="mfn-btn-xml" href="" target="_blank"><span>Get&nbsp;the&nbsp;XML&nbsp;file</span></a>';
									echo '<a class="mfn-btn-doc"  href="" target="_blank"><span>Documentation</span></a>';
									echo '<a class="mfn-btn-demo" href="/" target="_blank"><span>Demo</span></a>';
								echo '</div>';
							echo '</div>';
