...
html { 
	background-color: <?php aol_opts_show( 'background-html', '#FCFCFC' ) ?>;
}

#Wrapper, #Content { 
	background-color: <?php aol_opts_show( 'background-body', '#FCFCFC' ) ?>;
}
...
input[type="text"], input[type="password"], input[type="tel"], input[type="email"], textarea, select, .offer_li .title h3 {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-content', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}

#menu > ul > li > a, .action_button, #overlay-menu ul li a {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-menu', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}

#Subheader .title {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-title', 'Lora' ) ); ?>", Arial, Tahoma, sans-serif;
}

h1, h2, h3, h4, .text-logo #logo {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-headings', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}

h5, h6 {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-headings-small', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}

blockquote {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-blockquote', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}
...
.pricing-box .plan-header .price, .quick_fact .number-wrapper, .woocommerce .product div.entry-summary .price {
	font-family: "<?php echo str_replace( '#', '', aol_opts_get( 'font-decorative', 'Roboto' ) ); ?>", Arial, Tahoma, sans-serif;
}
...
<?php
	...
	if( is_array( aol_opts_get( 'font-size-content' ) ) ){
		
		$aFont = array(
			'content'	=> aol_opts_get( 'font-size-content' ),
			'big'		=> aol_opts_get( 'font-size-big' ),
			'menu'		=> aol_opts_get( 'font-size-menu' ),
			'title'		=> aol_opts_get( 'font-size-title' ),
			'h1'		=> aol_opts_get( 'font-size-h1' ),
			'h2'		=> aol_opts_get( 'font-size-h2' ),
			'h3'		=> aol_opts_get( 'font-size-h3' ),
			'h4'		=> aol_opts_get( 'font-size-h4' ),
			'h5'		=> aol_opts_get( 'font-size-h5' ),
			'h6'		=> aol_opts_get( 'font-size-h6' ),
			'intro'		=> aol_opts_get( 'font-size-single-intro' ),
		);
		...
		$defaults['content']['size'] = aol_opts_get( 'font-size-content', 14 );
		$defaults['big']['size'] = aol_opts_get( 'font-size-big', 16 );
		$defaults['menu']['size'] = aol_opts_get( 'font-size-menu', 15 );
		$defaults['title']['size'] = aol_opts_get( 'font-size-title', 30 );
		$defaults['h1']['size'] = aol_opts_get( 'font-size-h1', 48 );
		$defaults['h2']['size'] = aol_opts_get( 'font-size-h2', 30 );
		$defaults['h3']['size'] = aol_opts_get( 'font-size-h3', 25 );
		$defaults['h4']['size'] = aol_opts_get( 'font-size-h4', 21 );
		$defaults['h5']['size'] = aol_opts_get( 'font-size-h5', 15 );
		$defaults['h6']['size'] = aol_opts_get( 'font-size-h6', 14 );
		$defaults['intro']['size'] = aol_opts_get( 'font-size-single-intro', 70 );
...
<?php if( aol_opts_get('responsive') && aol_opts_get('font-size-responsive') ): ?>
...
<?php 
	$sidebarW 	= aol_opts_get( 'sidebar-width', '23' );
...
<?php if( aol_opts_get('responsive') ): ?>
	...
	<?php 
		$gridW = aol_opts_get( 'grid-width', 1240 );
	?>
	...
	<?php 
		if( $box_padding = aol_opts_get( 'layout-boxed-padding' ) ):
	?>
	...
	<?php 
		$mobileGridW = aol_opts_get( 'mobile-grid-width', 700 );
	?>
...
<?php
	$aLogo = array(
		'height' => intval( aol_opts_get( 'logo-height', 60 ) ),
		'vertical_padding' => intval( aol_opts_get( 'logo-vertical-padding', 15 ) ),
	);
...
<?php 
	$translate['before'] 	= aol_opts_get('translate') ? aol_opts_get('translate-before','Before') : __('Before','betheme');
	$translate['after'] 	= aol_opts_get('translate') ? aol_opts_get('translate-after','After') : __('After','betheme');
?>
